...
const SessionMessage = ({message}: { message: string }) => {
    return <div className={"text-xl text-center"}> {message}</div>
}
    ...
    return (
        <> 
            <div className='grid grid-rows-[auto_1fr_auto] items-start gap-y-2 bg-BgB text-white min-h-screen'>
                ...
                <main
                    className={"relative grid grid-rows-[auto_1fr_auto] gap-y-8 justify-items-center"}
                >
